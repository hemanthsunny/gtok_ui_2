...
const HeaderComponent = ({
  ...
  return (
    <nav
      className={`navbar fixed-top navbar-violet ${
        window.innerWidth > 576 && "d-none"
      }`}
    >
        ...
        <ul className="navbar-nav ml-auto">
          <li className="nav-item">
            <div className="nav-link p-0">
              ...
              <Link to="/app/alerts" className="bell-active" title="Alerts">
                <img
                  src={require("assets/svgs/BellActive.svg").default}
