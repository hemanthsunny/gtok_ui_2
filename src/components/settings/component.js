...
function SettingsComponent({
  ...
  const deleteUser = async () => {
    alert(
      "To delete your account, please give us an email at letsgtok@gmail.com"
    );
      ...
      <div>
        <div className="dashboard-content">
          <div className="container settings-wrapper desktop-align-center">
              ...
              <ul className="section-list d-none">
                <li>
                  <Link to="/app/settings/edit_profile" className="row">
                    <img
                      src={require("assets/svgs/EditProfile.svg").default}
                ...
                <li>
                  <Link to="/app/settings/change_password" className="row">
                    <img
                      src={require("assets/svgs/ChangePassword.svg").default}
                      className="scale-1-1 col-2"
                      alt="ChangePassword"
                    />
                ...
                <li className="">
                  <Link to="/app/settings/purchase_orders" className="row">
                    <img
                      src={require("assets/svgs/Payments.svg").default}
                ...
                <li className="">
                  <Link to="/app/settings/permissions" className="row">
                    <img
                      src={require("assets/svgs/Permission.svg").default}
                      className="scale-1-2 col-2"
                      alt="Permission"
                    />
                ...
                <li className="">
                  <Link
                    to="/app/settings"
                    className="row"
                    onClick={comeBackAlert}
                  >
                    <img
                      src={require("assets/svgs/Preferences.svg").default}
                      className="scale-0-9 col-2"
                      alt="Preferences"
                    />
                    <span className="option-name col-8">
            ...
            {currentUser.admin && (
              <AdminZoneComponent currentUser={currentUser} />
            )}
          </div>
        </div>
      </div>
