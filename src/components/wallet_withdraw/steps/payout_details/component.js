...
function PayoutComponent({
  ...
  const handleWithdrawAmount = (val) => {
    ...
    if (val > +wallet.amount) {
      ...
      setWithdrawAmountAlerts({
        message:
          "You cannot withdraw more than INR 100,000/- in a single withdrawal request",
        classname: "withdraw-danger-alert",
      });
      setDisableBtn(true);
    } else {
        ...
        <div className="">
          <div className="">
            <div className="form-group">
              ...
              <input
                type="number"
                className="form-control recharge-amount col-6"
                placeholder="INR"
          ...
          <div className="text-center mt-4">
            <button
              className="btn btn-sm btn-violet-rounded col-8"
              disabled={
                disableBtn || !accountName || !accountNumber || !ifscCode
              }
