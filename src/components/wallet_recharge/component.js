        ...
        <div className='wallet-recharge-wrapper'>
          {
            parentLoading
              ? <LoadingComponent />
              : <div>
                {stepNumber === 1 && <CheckoutComponent currentUser={currentUser} rechargeAmount={rechargeAmount} setRechargeAmount={setRechargeAmount} setStepNumber={setStepNumber} paymentIntent={paymentIntent} setPaymentIntent={setPaymentIntent} cancelPaymentIntent={cancelPaymentIntent} />}
                {stepNumber === 2 && <CardDetailsComponent currentUser={currentUser} rechargeAmount={rechargeAmount} setStepNumber={setStepNumber} paymentIntent={paymentIntent} cancelPaymentIntent={cancelPaymentIntent} />}
              </div>
          }
        </div>
      </div>
