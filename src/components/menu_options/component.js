...
const MenuOptionsComponent = ({
  ...
  const copyLink = async () => {
    navigator.clipboard.writeText(
      `https://app.letsgtok.com/app/assets/${displayPost.id}`
    );
  ...
  */
  ...
  return (
    <div
      ...
      tabIndex="-1"
      role="dialog"
      aria-labelledby="menuOptionsModalLabel"
      aria-hidden="true"
    >
        ...
        <div className="modal-content">
          <div className="modal-body p-0">
            ...
            <ul className="menu-list">
              <li
                className={`menu-item ${!displayPost.active && "d-none"}`}
                onClick={(e) => shareTo()}
              >
                Share to...
              </li>
              ...
              <li
                className={`menu-item ${
                  displayPost.userId === currentUser.id && "d-none"
                }`}
                data-toggle="modal"
              ...
              >
                <span onClick={(e) => hidePost()}>
                  {displayPost.active ? "Hide" : "Unhide"}
                </span>
                {displayPost.tradePrice >= 10 && (
                  <div className="fs-10">Purchased assets cannot be hidden</div>
                )}
              </li>
            </ul>
          </div>
