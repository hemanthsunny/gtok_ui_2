        ...
        <div className="row">
          <div className="col-12 order-2 order-sm-1 col-sm-6 left-block">
            <div className="header text-center">
              <img
                src={require("assets/svgs/login/left_header.svg").default}
            ...
            <div className="row justify-content-around body pb-5 mb-4 pb-sm-0 mb-sm-0">
              <img
                src={require("assets/svgs/login/left_infographic.svg").default}
                className="col-6 infographic"
                alt="Infographic"
              />
              <img
                src={require("assets/svgs/login/left_learn_more.svg").default}
                className="col-6 learn-more"
                alt="Learn more"
                onClick={redirectTo}
              />
            </div>
