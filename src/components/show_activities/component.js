  ...
  subHeader = () => (
    <div className="dashboard-tabs" role="navigation" aria-label="Main">
      <div className="tabs -big">
        <Link to="/app/assets" className="tab-item">
          Feelings
        </Link>
        <Link to="/app/activities" className="tab-item -active">
          Activities
        </Link>
      </div>
    </div>
...
export default connect(mapStateToProps, null)(withRouter(ParentComponent));
