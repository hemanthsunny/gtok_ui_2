      ...
      <div className='card reshare-post-card-wrapper'>
        <div className='card-body pb-3'>
          <div className='d-flex flex-row align-items-center justify-content-between'>
            <span className={`card-badge ${resharePost.category.key === 'special' && 'card-badge-special'} ${!post.active && 'hidden'}`} onClick={e => handleFilters('selected', resharePost.category.title)}>{resharePost.category && resharePost.category.title}</span>
