...
const ParentComponent = ({
  ...
  return (
    <div className='text-center mx-3 mx-sm-0'>
      <button className='btn btn-sm btn-special-outline-r' onClick={redirectToCreatePage}>
      <span dangerouslySetInnerHTML={{ __html: specialCategory.homepage_description }}></span>
      </button>
    </div>
  )
}
