                ...
                <div className='card post-card-wrapper' key={idx}>
                  <div>
                    ...
                    <div className='card-follow'>
                      <button className='btn btn-link p-0 pr-2' onClick={e => redirectToLogin('support the feeling.')}>
                  ...
                  <div className='card-body'>
                    <p className='white-space-preline'>
                      {post.stories[0].text.length <= 200
                        ? post.stories[0].text
                        : <span className='pointer' onClick={e => redirectToLogin('see full story.')}>{post.stories[0].text.slice(0, 199)} <small>. . . See full story</small></span>
                      }
                    </p>
                      ...
                      <div className='media-body'>
                        <h6>
                          ...
                          <div className='edit-options'>
                            <button className='btn btn-link btn-sm ml-2 fs-15 text-secondary' onClick={e => redirectToLogin('share the post.')}>
