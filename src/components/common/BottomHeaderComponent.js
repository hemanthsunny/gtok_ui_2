          ...
          <div className="nav-link text-center">
            <Link to="/app/assets">
              <img
                src={
                  metaDetails &&
                  (metaDetails.path === "posts" ||
                    metaDetails.path === "activities")
                    ? require("assets/svgs/HomeActive.svg").default
                    : require("assets/svgs/Home.svg").default
                }
                className="home-icon"
                alt="Home"
              />
          ...
          <div className="nav-link text-center">
            <Link to="/app/create_asset">
              <img
                src={
                  metaDetails &&
                  (metaDetails.path === "create_post" ||
                    metaDetails.path === "create_activity")
                    ? require("assets/svgs/PlusActive.svg").default
                    : require("assets/svgs/Plus.svg").default
                }
                className="plus-c-icon"
                alt="Create post"
              />
            </Link>
          </div>
        ...
        <div className="nav-item ml-1" title="Profile">
          <div className="nav-link text-center">
            <Link to="/app/profile">
              <img
                src={
                  metaDetails && metaDetails.path === "profile"
                    ? require("assets/svgs/ProfileActive.svg").default
                    : require("assets/svgs/Profile.svg").default
                }
...
export default connect(mapStateToProps, null)(BottomHeaderComponent);
