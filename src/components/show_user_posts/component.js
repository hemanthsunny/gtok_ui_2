...
class UserPostsComponent extends Component {
  ...
  subHeader = () => (
    <div className="d-flex flex-row justify-content-around feeling-sub-header">
      <div>
        <Link to={`/app/profile/${this.state.userId}/posts`} className="">
          Feeling
        </Link>
      </div>
      <div>
        <Link to={`/app/profile/${this.state.userId}/activities`} className="">
          Activity
        </Link>
      </div>
    </div>
          ...
          <div className="row feeling-wrapper">
            ...
            <div className="col-xs-12 col-md-7">
              ...
              */}
                <div className="d-flex">
                  <div
                    className="col-12 font-xs-small card p-2 create-post-card-type"
                  ...
                  >
                    <div className="d-flex align-self-center">
                      ...
                      <span>
                        Share an experience / Pinch a feeling. Click here
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="card right-sidebar-wrapper">
                <div className="card-body">
                  ...
                  <p className="profile-bot-description">
                    Hi! I am your personal friend (a bot). I can chat, work and
                    help you in daily activities. I am so happy to be your
                    personal friend,{" "}
                    {this.props.currentUser.displayName
                      .split(" ")[0]
                      .toUpperCase()}
                    . Will ping you once I am ready to chat...
                  </p>
                </div>
              </div>
            </div>
