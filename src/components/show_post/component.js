...
class ParentComponent extends Component {
  ...
  subHeader = () => (
    <div className="show-post-subheader" aria-label="Subheader">
      ...
      <div className="page-name">Feeling/Activity</div>
    </div>
  );
            ...
            <div className="feeling-wrapper">
              ...
              <Helmet>
                ...
                <meta
                  ...
                  content={
                    this.state.post &&
                    this.state.post.stories[0].text.substring(0, 15)
                  }
                />
                <meta
                  name="keywords"
                ...
                <div className="pt-5">
                  ...
                  <div className="text-center">
                    <FacebookShareButton
                      ...
                      title={this.state.post.category.title}
                      quote={this.state.post.stories[0].text}
                      hashtag="#letsgtok"
                    ...
                    <TwitterShareButton
                      url={this.state.postUrl}
                      title={this.state.post.stories[0].text}
                      hashtags="#letsgtok"
                      className="socialMediaButton"
                    >
                      <TwitterIcon size={36} />
                    ...
                    <LinkedinShareButton
                      url={this.state.postUrl}
                      title={this.state.post.stories[0].text}
                      summary={this.state.post.category.title}
                      source="Lets Gtok"
                      className="socialMediaButton"
                    >
